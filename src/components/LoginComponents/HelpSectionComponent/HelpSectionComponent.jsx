...
const HelpSectionComponent = () => {
    return (
        <div className='col-12 col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-3 mt-5 mx-0 '>
            {/* <div
            ...
            <div
                className='col-12 col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-12 mx-auto help-section'
                style={{width: '100%'}}>
